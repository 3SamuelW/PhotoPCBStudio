...
│   ├── gaussian_blur.cpp/h
│   ├── dp_simplify.cpp/h
│   ├── ledlayoutengine.cpp/h
│   ├── layergenerator.cpp/h
│   └── ledstrip.h
├── PhotoPCBStudio.pro    # Qt 项目文件
├── LICENSE
├── NOTICE.md
└── README.md
```
...
```
PhotoPCBStudio/
├── src/                  # All C++ source and Qt UI files
│   ├── main.cpp
│   ├── mainwindow.cpp/h/ui
│   ├── imageprocessor.cpp/h
│   ├── edgesharpener.cpp/h
...
│   ├── layergenerator.cpp/h
│   └── ledstrip.h
├── PhotoPCBStudio.pro    # Qt project file
├── LICENSE
├── NOTICE.md
└── README.md
```
